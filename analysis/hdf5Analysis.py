...
def hdf5AnalyzeSpecificAttributes(filePath, attributeKeys, attributeNames, title="", saveFig=False, xlims=None, ylims=None):
...
def overShootExample():
    filePath = ['../outputs/finally_good_for_real/hypopt_output_small_10deg_0.001dt_OVERSHOOT_EXAMPLE.h5']#,'../outputs/cyclone/hypopt_output_big_0.12vf_0.1deg_0.001ts_1000.h5']

    hdf5AnalyzeSpecificAttributes(filePath[0],
                                ["Temperature", "Compliance"],
                                ["Temperature", "Compliance"],
                                "10 Degree Simulation with 0.001 Timestep",
                                ylims=[[-2, 20], [-8e-9, 40]],#1.1e11]],
                                xlims=[-5, 300],
                                saveFig=True)

def overShootExampleLowerTimestep():
    filePath = '../outputs/finally_good_for_real/hypopt_output_small_10deg_0.0001dt_OVERSHOOT_BETTER.h5'

    hdf5AnalyzeSpecificAttributes(filePath,
                                ["Temperature", "Compliance"],
                                ["Temperature", "Compliance"],
                                "10 Degree Simulation with 0.0001 Timestep",
                                ylims=[[-2, 20], [-8e-9, 40]],#1.1e11]],
                                xlims=[-5, 3000],
                                saveFig=True)
...
def compareTwoFilesAllValues(filepaths):
    ...
    hdf5Analysis(filepaths, "Lambda",            "Lagrangian Multiplier" , distinguishingFeature="Temperature")#, single=True)
...
def analyzeDirectOutput(filePath=None, realTimeValue=False):
    ...
    hdf5Analysis(filePath, "Lambda",            "Lagrangian Multiplier" , single=True, realTimeValue=realTimeValue)
...
#    filePath = "G:/Projects/ENPH455/PETSc_paper_github/Hyperoptimization_using_Petsc/outputs/finally_good_for_real/5 Deg/hypopt_output_small_5deg_0.00001dt_60000.h5"
    filePath = "G:/Projects/ENPH455/PETSc_paper_github/Hyperoptimization_using_Petsc/outputs/finally_good_for_real/0 Deg/hypopt_output_small_0deg_0.1dt_49000.h5"
    analyzeDirectOutput(filePath, realTimeValue=False)
